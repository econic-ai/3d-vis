...
const CubeRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_cuberenderer_free(ptr >>> 0, 1));

export class CubeRenderer {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(CubeRenderer.prototype);
        obj.__wbg_ptr = ptr;
        CubeRendererFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        CubeRendererFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_cuberenderer_free(ptr, 0);
    }
    /**
     * @param {HTMLCanvasElement} canvas
     */
    constructor(canvas) {
        const ret = wasm.cuberenderer_new(canvas);
        return ret;
    }
    /**
     * @param {HTMLCanvasElement} canvas
     * @returns {Promise<CubeRenderer>}
     */
    static new_force_webgl(canvas) {
        const ret = wasm.cuberenderer_new_force_webgl(canvas);
        return ret;
    }
    /**
     * @param {HTMLCanvasElement} canvas
     ...
     * @returns {Promise<CubeRenderer>}
     */
    static new_with_background(canvas, background_color) {
        const ptr0 = passStringToWasm0(background_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.cuberenderer_new_with_background(canvas, ptr0, len0);
        return ret;
    }
    /**
     * @param {HTMLCanvasElement} canvas
     ...
     * @returns {Promise<CubeRenderer>}
     */
    static new_force_webgl_with_background(canvas, background_color) {
        const ptr0 = passStringToWasm0(background_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.cuberenderer_new_force_webgl_with_background(canvas, ptr0, len0);
        return ret;
    }
    /**
     * @param {number} width
     ...
     */
    resize(width, height) {
        wasm.cuberenderer_resize(this.__wbg_ptr, width, height);
    }
    /**
     * @param {number} delta
     */
    zoom(delta) {
        wasm.cuberenderer_zoom(this.__wbg_ptr, delta);
    }
    /**
     ...
     */
    pan(delta_x, delta_y) {
        wasm.cuberenderer_pan(this.__wbg_ptr, delta_x, delta_y);
    }
    /**
     * @param {number} delta_x
     * @param {number} delta_y
    ...
    rotate(delta_x, delta_y) {
        wasm.cuberenderer_rotate(this.__wbg_ptr, delta_x, delta_y);
    }
    render() {
        const ret = wasm.cuberenderer_render(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    /**
     * @returns {PerformanceSnapshot | undefined}
     */
    get_performance_snapshot() {
        const ret = wasm.cuberenderer_get_performance_snapshot(this.__wbg_ptr);
        return ret === 0 ? undefined : PerformanceSnapshot.__wrap(ret);
    }
    /**
     * @returns {number}
     */
    get_visible_objects() {
        const ret = wasm.cuberenderer_get_visible_objects(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_total_objects() {
        const ret = wasm.cuberenderer_get_total_objects(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_culling_ratio() {
        const ret = wasm.cuberenderer_get_culling_ratio(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} count
     */
    create_test_objects(count) {
        wasm.cuberenderer_create_test_objects(this.__wbg_ptr, count);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     * @param {number} radius
     */
    add_object(x, y, z, radius) {
        wasm.cuberenderer_add_object(this.__wbg_ptr, x, y, z, radius);
    }
    /**
     * @param {number} grid_size
     */
    enable_instancing_demo_with_size(grid_size) {
        wasm.cuberenderer_enable_instancing_demo_with_size(this.__wbg_ptr, grid_size);
    }
    enable_gizmo() {
        wasm.cuberenderer_enable_gizmo(this.__wbg_ptr);
    }
    disable_gizmo() {
        wasm.cuberenderer_disable_gizmo(this.__wbg_ptr);
    }
    /**
     * @returns {boolean}
     */
    is_gizmo_enabled() {
        const ret = wasm.cuberenderer_is_gizmo_enabled(this.__wbg_ptr);
        return ret !== 0;
    }
}

const PerformanceSnapshotFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_performancesnapshot_free(ptr >>> 0, 1));

export class PerformanceSnapshot {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PerformanceSnapshot.prototype);
        obj.__wbg_ptr = ptr;
        PerformanceSnapshotFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PerformanceSnapshotFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_performancesnapshot_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get timestamp() {
        const ret = wasm.__wbg_get_performancesnapshot_timestamp(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set timestamp(arg0) {
        wasm.__wbg_set_performancesnapshot_timestamp(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get render_calls_per_sec() {
        const ret = wasm.__wbg_get_performancesnapshot_render_calls_per_sec(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set render_calls_per_sec(arg0) {
        wasm.__wbg_set_performancesnapshot_render_calls_per_sec(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get actual_renders_per_sec() {
        const ret = wasm.__wbg_get_performancesnapshot_actual_renders_per_sec(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set actual_renders_per_sec(arg0) {
        wasm.__wbg_set_performancesnapshot_actual_renders_per_sec(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get dirty_ratio() {
        const ret = wasm.__wbg_get_performancesnapshot_dirty_ratio(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set dirty_ratio(arg0) {
        wasm.__wbg_set_performancesnapshot_dirty_ratio(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get frame_count() {
        const ret = wasm.__wbg_get_performancesnapshot_frame_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
    ...
    set frame_count(arg0) {
        wasm.__wbg_set_performancesnapshot_frame_count(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get dirty_frame_count() {
        const ret = wasm.__wbg_get_performancesnapshot_dirty_frame_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set dirty_frame_count(arg0) {
        wasm.__wbg_set_performancesnapshot_dirty_frame_count(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get avg_render_time_ms() {
        const ret = wasm.__wbg_get_performancesnapshot_avg_render_time_ms(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set avg_render_time_ms(arg0) {
        wasm.__wbg_set_performancesnapshot_avg_render_time_ms(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get object_count() {
        const ret = wasm.__wbg_get_performancesnapshot_object_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
    ...
    set object_count(arg0) {
        wasm.__wbg_set_performancesnapshot_object_count(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get edge_count() {
        const ret = wasm.__wbg_get_performancesnapshot_edge_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set edge_count(arg0) {
        wasm.__wbg_set_performancesnapshot_edge_count(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get vertex_count() {
        const ret = wasm.__wbg_get_performancesnapshot_vertex_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set vertex_count(arg0) {
        wasm.__wbg_set_performancesnapshot_vertex_count(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get index_count() {
        const ret = wasm.__wbg_get_performancesnapshot_index_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set index_count(arg0) {
        wasm.__wbg_set_performancesnapshot_index_count(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get memory_usage_mb() {
        const ret = wasm.__wbg_get_performancesnapshot_memory_usage_mb(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
    ...
    set memory_usage_mb(arg0) {
        wasm.__wbg_set_performancesnapshot_memory_usage_mb(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get scene_size_memory_mb() {
        const ret = wasm.__wbg_get_performancesnapshot_scene_size_memory_mb(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set scene_size_memory_mb(arg0) {
        wasm.__wbg_set_performancesnapshot_scene_size_memory_mb(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get active_view_memory_mb() {
        const ret = wasm.__wbg_get_performancesnapshot_active_view_memory_mb(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set active_view_memory_mb(arg0) {
        wasm.__wbg_set_performancesnapshot_active_view_memory_mb(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get visible_objects() {
        const ret = wasm.__wbg_get_performancesnapshot_visible_objects(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set visible_objects(arg0) {
        wasm.__wbg_set_performancesnapshot_visible_objects(this.__wbg_ptr, arg0);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_cuberenderer_new = function(arg0) {
        const ret = CubeRenderer.__wrap(arg0);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('three_d_vis_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
